# API Practice: Local Status-Record Exercises

## Problem

Practice two small Python problems: summarize failed requests by endpoint, and
find the first run of consecutive successful statuses. These are ordinary,
synthetic learning exercises, not actual assessment questions or a deployed API.

## Data

All data is invented and stored in the tests. There are no customer records,
credentials, external services, or network calls.
